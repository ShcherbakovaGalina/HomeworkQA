...
public class Task1 {
  ...
  public void testTask1() throws Exception {
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [captureEntirePageScreenshot | D:\Screenshots\test2.png | ]]
    driver.findElement(By.cssSelector("a[title=\"German\"]")).click();
    // ERROR: Caught exception [ERROR: Unsupported command [captureEntirePageScreenshot | D:\Screenshots\test3.png | ]]
    driver.findElement(By.cssSelector("a[title=\"Hauptseite besuchen [Alt+Shift+z]\"]")).click();
  }
